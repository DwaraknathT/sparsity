...
python 'sparsity/main.py' --model vgg16_bn --model_type dense --use_colab True \
...
python 'sparsity/main.py' --model vgg16_bn --model_type sparse --use_colab True \
--lr 0.05 --dataset cifar100 --run_name 'run1_weight' \
--final_sparsity 0.98 --end_step 0.5 --ramping True --ramp_type 'half_cycle'
...
# vgg sparse 90%
python 'sparsity/main.py' --model vgg16_bn --model_type sparse --use_colab True \
--lr 0.05 --dataset cifar100 --run_name 'run1_weight_um' \
--final_sparsity 0.9 --end_step 0.5 --ramping True --ramp_type 'half_cycle' --union_mask True

python 'sparsity/main.py' --model vgg16_bn --model_type sparse --use_colab True \
--lr 0.05 --dataset cifar100 --seed 128 --run_name 'run2_weight_um' \
--final_sparsity 0.9 --end_step 0.5 --ramping True --ramp_type 'half_cycle' --union_mask True

python 'sparsity/main.py' --model vgg16_bn --model_type sparse --use_colab True \
--lr 0.05 --dataset cifar100 --seed 3147 --run_name 'run3_weight_um' \
--final_sparsity 0.9 --end_step 0.5 --ramping True --ramp_type 'half_cycle' --union_mask True
